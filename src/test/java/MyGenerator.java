...
public class MyGenerator {
    ...
    public static void main(final String[] args) {
        ...
        gc.setOutputDir("G:\\123\\yuanyuanbao\\yuanyuanbao\\src\\main\\java\\");
...
//        });
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/yuanyuanbao?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC");
...
//        strategy.setTablePrefix(new String[]{"test_"});// 此处可以修改为您的表前缀
        ...
        pc.setParent("com.yuanbaobao.mini")
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(final TableInfo tableInfo) {
                return "G:\\123\\yuanyuanbao\\yuanyuanbao\\\\src\\main\\resources\\mapper\\" + tableInfo.getEntityName() + "Mapper" + ".xml";
            }
        });
        cfg.setFileOutConfigList(focList);
        mpg.setCfg(cfg);
