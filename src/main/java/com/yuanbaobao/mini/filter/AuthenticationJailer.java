            ...
            if (ignorePath.contains(path)) {
                ...
                if (authHeader != null && authHeader.startsWith("Bearer ")) {
                    ...
                    if (!this.jwtTokenUtil.isTokenExpired(authToken)) {
                        ...
                        ResponseUtils.renderToken(httpRequest,httpResponse, Result.error(CodeMsg.create(8843, "token过期!")));
                    }
                } else {
                    ResponseUtils.renderToken(httpRequest,httpResponse, Result.error(CodeMsg.create(10002, "请输入token!")));
                    return;
                }
            }
        }
