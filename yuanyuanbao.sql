...
CREATE TABLE `carousel` (
  ...
  `c_name` varchar(30) NOT NULL COMMENT '轮播图片名称',
  `c_img_url` varchar(1024) NOT NULL COMMENT '图片地址',
  `c_order` int(10) NOT NULL DEFAULT '0' COMMENT '图片顺序',
  `redict_url` varchar(512) DEFAULT NULL COMMENT '跳转地址',
...
/*Table structure for table `design_category_middle` */

DROP TABLE IF EXISTS `design_category_middle`;

CREATE TABLE `design_category_middle` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键ID',
...
/*Data for the table `design_category_middle` */

insert  into `design_category_middle`(`id`,`design_id`,`cate_id`) values (1,1,1),(2,1,2),(3,2,1),(4,2,4);
...
insert  into `design_tags_middle`(`id`,`design_id`,`tag_id`) values (1,1,2),(2,1,3),(3,1,4),(4,2,1),(5,2,2);
...
CREATE TABLE `project_design` (
  ...
  `is_hot` int(1) NOT NULL DEFAULT '0' COMMENT '0 非热门 1热门',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
insert  into `project_design`(`id`,`project_id`,`title_name`,`title_desc`,`title_content`,`integration`,`user_view_num`,`share_num`,`exchange_num`,`download_url`,`current_status`,`is_hot`,`create_time`,`update_time`,`is_del`,`lock_version`) values (1,'123','基于springboot的医疗管理系统','这是一款基于springboot的医疗管理系统','默认这是一段html',3000,1,2,1,'www.baidu.com',1,0,'2021-07-06 20:52:01','2021-07-08 21:26:42',0,0),(2,'456','基于springboot的医疗管理系统2','基于springboot的医疗管理系统2','基于springboot的医疗管理系统2',4000,2,2,2,'www.baidu.com',1,0,'2021-07-06 20:53:01','2021-07-06 20:53:01',0,0);
